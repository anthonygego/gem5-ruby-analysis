...
%         'system.ruby.network.msg_byte.Unblock_Control',...
%         'system.ruby.network.msg_byte.Invalidate_Control',...
%         'system.ruby.network.msg_byte.ResponseL2hit_Data',...
%         'system.ruby.network.msg_byte.ResponseLocal_Data'};
% 
...
%         'system.ruby.network.msg_count.Invalidate_Control',...
%         'system.ruby.network.msg_count.ResponseL2hit_Data',...
%         'system.ruby.network.msg_count.ResponseLocal_Data'};
% 
%     make_1var_graph('cacheline_size', 'variation', '64B', 'benchmark', events, [], 'Coherence message count', 'Amount');
end
